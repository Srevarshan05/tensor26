  ...
  return (
    <>
      ...
      <div className="fixed top-8 w-full z-50 px-4 pointer-events-none">
        <nav className={`mx-auto max-w-fit pointer-events-auto flex items-center border border-white/30 px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 glass-morphism ${
          isDarkText ? 'shadow-lg text-slate-900' : 'text-white'
        }`}>
          ...
          <div className="hidden ml-8 md:flex items-center gap-3">
            <button
              ...
              className="border border-slate-200 hover:bg-slate-50 px-5 py-2 rounded-full text-xs font-bold transition"
            >
              Contact
            </button>
            <a 
