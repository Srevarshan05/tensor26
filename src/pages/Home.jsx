  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 pt-[45vh] md:pt-[60vh] pb-32 overflow-hidden bg-[#fdfdfd] mt-[-1px]">
        ...
        {/* ─── Find Us Here - Google Maps Section ─── */}
        <div className="relative z-20 w-full mt-32 px-4">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              <p className="text-[10px] md:text-xs uppercase tracking-[0.4em] font-black text-primary mb-4 opacity-60">
                Venue Location
              </p>
              <h2
                className="text-3xl md:text-5xl font-black tracking-tight text-on-surface mb-4"
                style={{ fontFamily: "'Orbitron', sans-serif" }}
              >
                Find Us <span className="text-primary">Here</span>
              </h2>
              <p className="text-on-surface-variant text-sm md:text-base font-medium mb-10 max-w-xl mx-auto">
            ...
            <motion.div
              ...
              className="rounded-[2rem] overflow-hidden shadow-2xl border border-black/5 hover:shadow-[0_25px_60px_-12px_rgba(0,0,0,0.15)] transition-shadow duration-500"
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.123!2d78.5731!3d10.9567!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3baaf5533ff8a9a1%3A0x3747013252dab2a1!2sSRM%20Institute%20of%20Science%20and%20Technology%20-%20Tiruchirappalli%20Campus!5e0!3m2!1sen!2sin!4v1"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen=""
                ...
                title="SRM IST Trichy Location"
                className="w-full h-[300px] md:h-[450px]"
              />
            </motion.div>

            <a
              href="https://maps.app.goo.gl/BqYUYVq3LyESCozt7"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-6 px-6 py-3 rounded-full bg-primary/5 hover:bg-primary/10 text-primary font-bold text-sm transition-all duration-300 hover:scale-105"
            >
              <span className="material-symbols-outlined text-lg" style={{ fontVariationSettings: "'FILL' 1" }}>open_in_new</span>
              Open in Google Maps
            </a>
          </div>
        </div>
            ...
            <div className="flex flex-wrap justify-center items-center gap-16">
              {organizers.map((org, i) => (
                ...
                >
                  <img
                    src={org.src}
                    alt={`${org.name} - TENSOR26 Hackathon SRM Trichy`}
